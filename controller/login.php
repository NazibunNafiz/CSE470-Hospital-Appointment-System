...
<form action="<?php $_SERVER['PHP_SELF'] ;?>" method="post" name="" class="form-signin">
  <h1 class="h3 mb-3 font-weight-normal text-white">General Hospital</h1>
  <h1 class="h3 mb-3 font-weight-normal text-white">Login Panel</h1>
